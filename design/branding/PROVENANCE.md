# AI Engine Room production-icon provenance
...
brand artwork for AI Engine Room.

Repository source: `TartanleafLogo.jpg`
...
- `ai-engine-room-icon-master.png` (1024 px)
- `ai-engine-room-icon-512.png`
- `ai-engine-room-icon-256.png`
- `ai-engine-room-icon-128.png`
- `ai-engine-room-icon-64.png`
- `ai-engine-room-icon-48.png`
- `ai-engine-room-icon-32.png`
- `ai-engine-room-icon-16.png`

The 64/48/32/16 images are deliberate small-size treatments. Production assets
are generated deterministically by `build-icon-assets.py`; they are not generated
or aesthetically reinterpreted by an image model.
