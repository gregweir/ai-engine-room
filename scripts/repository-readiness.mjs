...
const required = [
  ...
  "docs/design/milestone-2c-reviewed-local-helper-amendment.md",
  ...
  "scripts/milestone-2c-ubuntu-local-console-helper.sh",
  "scripts/milestone-2c-ubuntu-local-console-helper.test.mjs",
